        ...
        <div className="p-10 items-center justify-center">
          <div className="flex flex-col mx-auto space-y-10 max-w-[540px] h-full justify-center">
            <div className="flex space-y-5 flex-col">
              <p className="text-5xl text-white">Sign up</p>
            ...
            <div className="grid gap-y-3">
              ...
              <input
                type="text"
                className="flex-1 rounded-lg focus-visible:outline focus-visible:outline-[#4d4463] focus:outline-none bg-[#2a2535] p-3 placeholder:text-[#4b4558]"
                placeholder="Email"
              />
              <input
                type="text"
